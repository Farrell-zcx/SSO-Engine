        ...
        <div class="w-full max-w-[440px]">
            ...
            <div class="text-center mb-xl flex flex-col items-center">
                <div class="flex items-center gap-3 mb-2">
                    <span class="material-symbols-outlined text-[48px] text-primary">admin_panel_settings</span>
                    <h1 class="font-headline-xl text-headline-xl text-primary tracking-tight">SSO <span class="text-secondary">Admin</span></h1>
                </div>
                <p class="font-body-md text-body-md text-on-surface-variant mt-xs">Login untuk masuk ke <strong>Dashboard Admin SSO</strong></p>
            </div>
            ...
            <div class="glass-panel rounded-xl p-xl login-card-shadow">
                <form action="<?= site_url('authorize-admin/login') ?>" method="post" class="space-y-lg">
                    <?= csrf_field() ?>
                    
                    <div class="space-y-xs">
                        <label class="font-label-sm text-label-sm text-on-surface-variant block uppercase tracking-wider" for="login_id">Email atau Username Admin</label>
                    ...
                    <button class="w-full h-[52px] bg-primary text-on-primary font-label-md text-label-md rounded-lg hover:bg-[#333] active:scale-[0.98] transition-all flex items-center justify-center gap-xs shadow-md" type="submit">
