...
<body class="liquid-bg text-on-surface min-h-screen flex flex-col">
    <div class="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        <div class="absolute top-[-10%] left-[-5%] w-[40%] h-[40%] rounded-full bg-red-500 opacity-[0.03] blur-[120px]"></div>
        <div class="absolute bottom-[-10%] right-[-5%] w-[40%] h-[40%] rounded-full bg-red-500 opacity-[0.03] blur-[120px]"></div>
    </div>
    ...
    <main class="relative z-10 flex-grow flex flex-col items-center justify-center px-margin-mobile md:px-margin-desktop py-xl">
        <div class="w-full max-w-[440px]">
            <div class="glass-panel rounded-xl p-xl login-card-shadow text-center">
                <span class="material-symbols-outlined text-[64px] text-red-500 mb-4">cancel</span>
                <h1 class="font-headline-xl text-[24px] text-primary tracking-tight mb-2">Link Tidak Valid</h1>
                <p class="font-body-md text-body-md text-on-surface-variant mb-6">
                    <?= esc($message ?? 'Token reset password tidak valid atau sudah kadaluarsa.') ?>
                </p>
                <div class="p-4 bg-red-50 rounded-lg border border-red-100 text-red-800 text-sm mb-6 inline-block w-full">
                    Silakan tutup halaman ini dan ulangi proses "Lupa Password" dari aplikasi Anda.
                </div>
            </div>
        </div>
    </main>
