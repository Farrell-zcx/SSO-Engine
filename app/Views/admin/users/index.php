...
<body class="liquid-bg text-on-surface min-h-screen flex flex-col relative overflow-x-hidden">
    ...
    <main class="relative z-10 flex-grow container mx-auto px-4 py-8 max-w-6xl">
        ...
        <?php if (session()->getFlashdata('error')): ?>
            <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)" x-transition.duration.500ms class="mb-6 p-4 bg-error-container text-on-error-container border border-error/10 rounded-lg flex items-start gap-3 shadow-sm animate-fade-in">
