...
# Pastikan folder keys (JWT RS256) punya permission yang benar
RUN if [ -d /var/www/html/keys ]; then \
    chmod 600 /var/www/html/keys/private.pem && \
    chmod 644 /var/www/html/keys/public.pem; \
    fi
